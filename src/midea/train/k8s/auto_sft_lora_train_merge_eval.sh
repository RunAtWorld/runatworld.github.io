...
CKPT_SAVE_DIR="/apps/hw/outputs/midea/qwen3/14b/save_weights_lora/qwen3_14b_mcore_tp4pp2_intent10k_qwen3_think_16/"
CKPT_SAVE_DIR_MERGE="/apps/hw/outputs/midea/qwen3/14b/save_weights_lora/qwen3_14b_mcore_tp4pp2_intent10k_qwen3_think_merge_16/"
...
train_log_path="logs/tune_qwen3_14b_lora_intent10k_16.log"
tensorboard_dir="/apps/hw/outputs/qwen3/14b/tb/lora/midea/intent10k_16"
# Evaluation params
CHECKPOINT_LORA=$CKPT_SAVE_DIR
EVAL_DATA_PATH="/apps/hw/datasets/midea_dataset/intent/intent_test_1k.jsonl"
eval_log_path="logs/ganerate_qwen3_14b_lora_intent10k_ptd_16.log"
