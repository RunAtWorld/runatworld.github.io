...
CHECKPOINT="${OUTPUT_BASE_DIR}/14b/save_weights_lora/qwen3_14b_mcore_tp4pp2_intent10k_qwen3_think_merge/" # 指向微调后权重的保存路径
TOKENIZER_PATH="/data/share/platform_test/models/Qwen3-14B/" # 指向模型tokenizer的路径
eval_log_path="${OUTPUT_BASE_DIR}/14b/logs/eval_qwen3_14b_lora_intent10k.log"
