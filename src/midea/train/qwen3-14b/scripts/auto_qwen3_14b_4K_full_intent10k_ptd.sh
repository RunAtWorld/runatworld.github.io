...
EXP_NUM=28 #实验编号，每个实验都会生成一个单独的目录
...
CKPT_SAVE_DIR="${OUTPUT_BASE_DIR}/14b/save_weights_full/qwen3_14b_mcore_tp4pp2_intent10k_qwen3_think_${EXP_NUM}/"  #训练完成后的权重保存路径
...
tensorboard_dir="${OUTPUT_BASE_DIR}/14b/tb/full/intent10k_${EXP_NUM}"
train_log_path="${OUTPUT_BASE_DIR}/14b/logs/tune_qwen3_14b_full_intent10k_${EXP_NUM}.log"
# Evaluation params
CHECKPOINT=$CKPT_SAVE_DIR
EVAL_DATA_PATH="/data/share/platform_test/datasets/intent_test_1k.jsonl"
eval_log_path="${OUTPUT_BASE_DIR}/14b/logs/eval_qwen3_14b_intent10k_${EXP_NUM}.log"
